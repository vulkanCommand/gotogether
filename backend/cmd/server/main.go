...
func main() {
	...
	api.POST("/users/:id/block", handlers.BlockUser)
	api.DELETE("/users/:id/block", handlers.UnblockUser)
	api.POST("/trips", handlers.CreateTrip)
	api.GET("/trips", handlers.GetTrips)
	api.POST("/trips/invites/:token/accept", handlers.AcceptTripInvite)
	api.GET("/trips/:id", handlers.GetTripByID)
	api.PATCH("/trips/:id", handlers.UpdateTrip)
	api.DELETE("/trips/:id", handlers.DeleteTrip)
	api.POST("/trips/:id/invite", handlers.CreateTripInvite)
	api.POST("/trips/:id/members", handlers.AddTripMembers)
	api.DELETE("/trips/:id/members/:userId", handlers.RemoveTripMember)
	...
	api.POST("/trips/:id/itinerary/days/:dayId/events/reorder", handlers.ReorderItineraryDayEvents)
	...
	api.DELETE("/trips/:id/photos/:photoId", handlers.DeleteTripPhoto)
