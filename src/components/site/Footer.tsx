...
export default function Footer() {
  return (
    <footer className="border-t border-border bg-card">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 px-5 py-12 sm:grid-cols-2 lg:grid-cols-4 lg:px-8">
        <div>
          <Logo />
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><Link to="/support" className="text-foreground hover:text-accent">Support</Link></li>
            <li><Link to="/privacy" className="text-foreground hover:text-accent">Privacy Policy</Link></li>
            <li><Link to="/terms" className="text-foreground hover:text-accent">Terms of Service</Link></li>
            <li><Link to="/delete-account" className="text-foreground hover:text-accent">Delete account</Link></li>
          </ul>
        </div>
      </div>
